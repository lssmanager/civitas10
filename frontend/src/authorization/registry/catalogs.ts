...
export const activePermissions = new Set<PermissionKey>(["owner.read", "owner.write", "owner.organizations.read", "owner.organizations.create", "owner.system.read", "account.profile.read", "lms.grades.read", "lms.grades.manage", "analytics.reports.read", "governance.owner.read", "governance.tenant.read", "governance.preview.read"].map((item) => item as PermissionKey));
