...
export const ownerOverviewScreen = defineScreen({
  ...
  navigation: { menuKey: "owner.overview", labelKey: "navigation.owner.overview", breadcrumbKey: "breadcrumbs.owner.overview", iconKey: "dashboard", responsiveGroup: "owner", order: 10 },
