...
export const tenantGovernanceScreen = defineScreen({
  ...
  navigation: { menuKey: "tenant.governance", labelKey: "navigation.tenant.governance", breadcrumbKey: "breadcrumbs.tenant.governance", iconKey: "settings", responsiveGroup: "organizations", order: 20 },
