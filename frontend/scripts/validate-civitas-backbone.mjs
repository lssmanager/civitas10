...
if (!auth.includes("VITE_API_URL") || !auth.includes("sub === client_id") || !auth.includes("ownerApiFetch")) fail("owner auth documentation must explain API resource and user-token guard");
